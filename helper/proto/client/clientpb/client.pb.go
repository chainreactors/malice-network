...
var file_client_clientpb_client_proto_rawDesc = []byte{
	...
	0x62, 0x61, 0x64, 0x67, 0x65, 0x55, 0x72, 0x6c, 0x42, 0x46, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68,
...
var file_client_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_client_clientpb_client_proto_goTypes = []any{
	...
	nil,                           // 71: clientpb.Website.ContentsEntry
	nil,                           // 72: clientpb.GithubWorkflowRequest.InputsEntry
	(*implantpb.Os)(nil),          // 73: modulepb.Os
	(*implantpb.Process)(nil),     // 74: modulepb.Process
	(*implantpb.Timer)(nil),       // 75: modulepb.Timer
	(*implantpb.Addon)(nil),       // 76: modulepb.Addon
	(*implantpb.Spite)(nil),       // 77: implantpb.Spite
	(*implantpb.Register)(nil),    // 78: modulepb.Register
}
var file_client_clientpb_client_proto_depIdxs = []int32{
	29, // 0: clientpb.Session.tasks:type_name -> clientpb.Tasks
	73, // 1: clientpb.Session.os:type_name -> modulepb.Os
	74, // 2: clientpb.Session.process:type_name -> modulepb.Process
	75, // 3: clientpb.Session.timer:type_name -> modulepb.Timer
	76, // 4: clientpb.Session.addons:type_name -> modulepb.Addon
	...
	77, // 10: clientpb.SpiteCacheItem.spite:type_name -> implantpb.Spite
	...
	77, // 23: clientpb.Event.spite:type_name -> implantpb.Spite
	...
	77, // 27: clientpb.TaskContext.spite:type_name -> implantpb.Spite
	28, // 28: clientpb.TaskContexts.task:type_name -> clientpb.Task
	2,  // 29: clientpb.TaskContexts.session:type_name -> clientpb.Session
	77, // 30: clientpb.TaskContexts.spites:type_name -> implantpb.Spite
	...
	78, // 39: clientpb.RegisterSession.register_data:type_name -> modulepb.Register
	...
	77, // 43: clientpb.SpiteRequest.spite:type_name -> implantpb.Spite
	77, // 44: clientpb.SpiteResponse.spite:type_name -> implantpb.Spite
	...
	71, // 53: clientpb.Website.contents:type_name -> clientpb.Website.ContentsEntry
	...
	72, // 56: clientpb.GithubWorkflowRequest.inputs:type_name -> clientpb.GithubWorkflowRequest.InputsEntry
