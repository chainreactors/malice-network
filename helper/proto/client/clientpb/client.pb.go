...
var file_client_clientpb_client_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xd8, 0x01, 0x0a, 0x09,
	...
	0x63, 0x74, 0x72, 0x6c, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x70, 0x62, 0x2e, 0x57, 0x65, 0x62, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x63,
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x75, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x03, 0x54, 0x4c, 0x53, 0x12, 0x22, 0x0a, 0x04,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x2c, 0x0a, 0x05, 0x43, 0x65, 0x72, 0x74, 0x73, 0x12, 0x23,
	...
	0x22, 0x9d, 0x03, 0x0a, 0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x74,
	...
	0x72, 0x6b, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x55, 0x72, 0x6c, 0x12, 0x2b, 0x0a, 0x11,
	...
	0x22, 0xa4, 0x02, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x39, 0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x74, 0x65,
...
var file_client_clientpb_client_proto_depIdxs = []int32{
	...
	62, // 18: clientpb.JobStatus.content:type_name -> clientpb.WebContent
	47, // 19: clientpb.Listener.pipelines:type_name -> clientpb.Pipelines
	14, // 20: clientpb.Listeners.listeners:type_name -> clientpb.Listener
	16, // 21: clientpb.Clients.clients:type_name -> clientpb.Client
	2,  // 22: clientpb.Event.session:type_name -> clientpb.Session
	10, // 23: clientpb.Event.job:type_name -> clientpb.Job
	16, // 24: clientpb.Event.client:type_name -> clientpb.Client
	27, // 25: clientpb.Event.task:type_name -> clientpb.Task
	85, // 26: clientpb.Event.spite:type_name -> implantpb.Spite
	18, // 27: clientpb.Events.events:type_name -> clientpb.Event
	27, // 28: clientpb.TaskContext.task:type_name -> clientpb.Task
	2,  // 29: clientpb.TaskContext.session:type_name -> clientpb.Session
	85, // 30: clientpb.TaskContext.spite:type_name -> implantpb.Spite
	27, // 31: clientpb.TaskContexts.task:type_name -> clientpb.Task
	2,  // 32: clientpb.TaskContexts.session:type_name -> clientpb.Session
	85, // 33: clientpb.TaskContexts.spites:type_name -> implantpb.Spite
	24, // 34: clientpb.TasksContext.contexts:type_name -> clientpb.TaskContext
	27, // 35: clientpb.Tasks.tasks:type_name -> clientpb.Task
	32, // 36: clientpb.TaskDescs.tasks:type_name -> clientpb.TaskDesc
	30, // 37: clientpb.Files.files:type_name -> clientpb.File
	34, // 38: clientpb.Plugins.plugins:type_name -> clientpb.Plugin
	39, // 39: clientpb.Artifacts.artifacts:type_name -> clientpb.Artifact
	41, // 40: clientpb.Profiles.profiles:type_name -> clientpb.Profile
	86, // 41: clientpb.RegisterSession.register_data:type_name -> modulepb.Register
	47, // 42: clientpb.RegisterListener.pipelines:type_name -> clientpb.Pipelines
	2,  // 43: clientpb.SpiteRequest.session:type_name -> clientpb.Session
	27, // 44: clientpb.SpiteRequest.task:type_name -> clientpb.Task
	85, // 45: clientpb.SpiteRequest.spite:type_name -> implantpb.Spite
	85, // 46: clientpb.SpiteResponse.spite:type_name -> implantpb.Spite
	48, // 47: clientpb.Pipelines.pipelines:type_name -> clientpb.Pipeline
	50, // 48: clientpb.Pipeline.tls:type_name -> clientpb.TLS
	...
	48, // 55: clientpb.CtrlPipeline.pipeline:type_name -> clientpb.Pipeline
	52, // 56: clientpb.TLS.cert:type_name -> clientpb.Cert
	52, // 57: clientpb.TLS.ca:type_name -> clientpb.Cert
	53, // 58: clientpb.TLS.cert_subject:type_name -> clientpb.CertificateSubject
	50, // 59: clientpb.Certs.certs:type_name -> clientpb.TLS
	78, // 60: clientpb.REM.agents:type_name -> clientpb.REM.AgentsEntry
	58, // 61: clientpb.REMAgents.agents:type_name -> clientpb.REMAgent
	79, // 62: clientpb.Website.contents:type_name -> clientpb.Website.ContentsEntry
	63, // 63: clientpb.Websites.websites:type_name -> clientpb.Website
	62, // 64: clientpb.WebContents.contents:type_name -> clientpb.WebContent
	80, // 65: clientpb.BuildConfig.inputs:type_name -> clientpb.BuildConfig.InputsEntry
	68, // 66: clientpb.BuildConfig.github:type_name -> clientpb.GithubWorkflowConfig
	70, // 67: clientpb.GithubWorkflows.workflows:type_name -> clientpb.GithubWorkflow
	2,  // 68: clientpb.Context.session:type_name -> clientpb.Session
	27, // 69: clientpb.Context.task:type_name -> clientpb.Task
	48, // 70: clientpb.Context.pipeline:type_name -> clientpb.Pipeline
	14, // 71: clientpb.Context.listener:type_name -> clientpb.Listener
	73, // 72: clientpb.Contexts.contexts:type_name -> clientpb.Context
	62, // 73: clientpb.Job.ContentsEntry.value:type_name -> clientpb.WebContent
	58, // 74: clientpb.REM.AgentsEntry.value:type_name -> clientpb.REMAgent
	62, // 75: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
