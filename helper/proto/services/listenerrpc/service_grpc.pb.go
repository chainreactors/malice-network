...
type ListenerRPCClient interface {
	...
	Build(ctx context.Context, in *clientpb.BuildConfig, opts ...grpc.CallOption) (*clientpb.Builder, error)
	DockerStatus(ctx context.Context, in *clientpb.Empty, opts ...grpc.CallOption) (*clientpb.Empty, error)
	WorkflowStatus(ctx context.Context, in *clientpb.BuildConfig, opts ...grpc.CallOption) (*clientpb.Empty, error)
...
func (c *listenerRPCClient) Build(ctx context.Context, in *clientpb.BuildConfig, opts ...grpc.CallOption) (*clientpb.Builder, error) {
...
func (c *listenerRPCClient) WorkflowStatus(ctx context.Context, in *clientpb.BuildConfig, opts ...grpc.CallOption) (*clientpb.Empty, error) {
	out := new(clientpb.Empty)
...
type ListenerRPCServer interface {
	...
	Build(context.Context, *clientpb.BuildConfig) (*clientpb.Builder, error)
	DockerStatus(context.Context, *clientpb.Empty) (*clientpb.Empty, error)
	WorkflowStatus(context.Context, *clientpb.BuildConfig) (*clientpb.Empty, error)
...
func (UnimplementedListenerRPCServer) Build(context.Context, *clientpb.BuildConfig) (*clientpb.Builder, error) {
...
func (UnimplementedListenerRPCServer) WorkflowStatus(context.Context, *clientpb.BuildConfig) (*clientpb.Empty, error) {
...
func _ListenerRPC_WorkflowStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListenerRPCServer).WorkflowStatus(ctx, req.(*clientpb.BuildConfig))
	}
	return interceptor(ctx, in, info, handler)
}
