...
type MaliceRPCClient interface {
	...
	FindArtifact(ctx context.Context, in *clientpb.Builder, opts ...grpc.CallOption) (*clientpb.Builder, error)
...
func (c *maliceRPCClient) FindArtifact(ctx context.Context, in *clientpb.Builder, opts ...grpc.CallOption) (*clientpb.Builder, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(clientpb.Builder)
...
type MaliceRPCServer interface {
	...
	FindArtifact(context.Context, *clientpb.Builder) (*clientpb.Builder, error)
...
func (UnimplementedMaliceRPCServer) FindArtifact(context.Context, *clientpb.Builder) (*clientpb.Builder, error) {
...
func _MaliceRPC_FindArtifact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaliceRPCServer).FindArtifact(ctx, req.(*clientpb.Builder))
	}
	return interceptor(ctx, in, info, handler)
}
