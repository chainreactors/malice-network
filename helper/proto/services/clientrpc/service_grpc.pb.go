...
type MaliceRPCClient interface {
	...
	// certs
	GenerateSelfCertificate(ctx context.Context, in *clientpb.TLS, opts ...grpc.CallOption) (*clientpb.Empty, error)
...
func (c *maliceRPCClient) BuildLog(ctx context.Context, in *clientpb.Artifact, opts ...grpc.CallOption) (*clientpb.Artifact, error) {
...
func (c *maliceRPCClient) GenerateSelfCertificate(ctx context.Context, in *clientpb.TLS, opts ...grpc.CallOption) (*clientpb.Empty, error) {
	out := new(clientpb.Empty)
...
type MaliceRPCServer interface {
	...
	// certs
	GenerateSelfCertificate(context.Context, *clientpb.TLS) (*clientpb.Empty, error)
...
func (UnimplementedMaliceRPCServer) BuildLog(context.Context, *clientpb.Artifact) (*clientpb.Artifact, error) {
...
func (UnimplementedMaliceRPCServer) GenerateSelfCertificate(context.Context, *clientpb.TLS) (*clientpb.Empty, error) {
...
func _MaliceRPC_BuildLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaliceRPCServer).BuildLog(ctx, req.(*clientpb.Artifact))
	}
	return interceptor(ctx, in, info, handler)
}
