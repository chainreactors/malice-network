...
const (
	...
	MaliceRPC_GetActionProgress_FullMethodName     = "/clientrpc.MaliceRPC/GetActionProgress"
...
type MaliceRPCClient interface {
	...
	GetActionProgress(ctx context.Context, in *clientpb.GithubWorkflowRequest, opts ...grpc.CallOption) (*clientpb.Artifact, error)
	// config
...
func (c *maliceRPCClient) GetActionProgress(ctx context.Context, in *clientpb.GithubWorkflowRequest, opts ...grpc.CallOption) (*clientpb.Artifact, error) {
	out := new(clientpb.Artifact)
	err := c.cc.Invoke(ctx, MaliceRPC_GetActionProgress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MaliceRPCServer interface {
	...
	GetActionProgress(context.Context, *clientpb.GithubWorkflowRequest) (*clientpb.Artifact, error)
	// config
...
func (UnimplementedMaliceRPCServer) GetActionProgress(context.Context, *clientpb.GithubWorkflowRequest) (*clientpb.Artifact, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActionProgress not implemented")
}
...
func _MaliceRPC_GetActionProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.GithubWorkflowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaliceRPCServer).GetActionProgress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MaliceRPC_GetActionProgress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaliceRPCServer).GetActionProgress(ctx, req.(*clientpb.GithubWorkflowRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MaliceRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetActionProgress",
			Handler:    _MaliceRPC_GetActionProgress_Handler,
		},
		{
