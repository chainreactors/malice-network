...
func ServiceCreate(rpc clientrpc.MaliceRPCClient, session *session.Session, name, displayName, executablePath string, startType, errorControl, accountName string) (*clientpb.Task, error) {
