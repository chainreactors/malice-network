...
func Commands(con *repl.Console) []*cobra.Command {
	listenerCmd := &cobra.Command{
		...
		Long:  help.FormatLongHelp("Use a table to list listeners on the server"),
...
listener
	...
	jobCmd := &cobra.Command{
		...
		Long:  help.FormatLongHelp("Use a table to list jobs on the server"),
		Run: func(cmd *cobra.Command, args []string) {
			listJobsCmd(cmd, con)
			return
		},
...
job
	...
	tcpCmd := &cobra.Command{
		...
		Long:  help.FormatLongHelp("Use a table to list TCP pipelines along with their corresponding listeners"),
...
tcp listener
	...
	tcpRegisterCmd := &cobra.Command{
		...
		Args:  cobra.ExactArgs(1),
		Long: help.FormatLongHelp(`Register a new TCP pipeline with the specified listener.
...
tcp register listener --tls --cert_path /path/to/cert --key_path /path/to/key
	...
	tcpStartCmd := &cobra.Command{
		...
		Long:  help.FormatLongHelp("Start a TCP pipeline with the specified name and listener ID"),
		Run: func(cmd *cobra.Command, args []string) {
...
tcp start tcp_test listener
	...
	tcpStopCmd := &cobra.Command{
		...
		Args:  cobra.ExactArgs(2),
		Long:  help.FormatLongHelp("Stop a TCP pipeline with the specified name and listener ID"),
		Run: func(cmd *cobra.Command, args []string) {
...
tcp stop tcp_test listener
	...
	websiteCmd := &cobra.Command{
		...
		Long:  help.FormatLongHelp("Use a table to list websites along with their corresponding listeners"),
		Args:  cobra.ExactArgs(1),
		Run: func(cmd *cobra.Command, args []string) {
...
website listener
	...
	websiteRegisterCmd := &cobra.Command{
		...
		Long: help.FormatLongHelp(`Register a new website with the specified listener.
...
~~~`),
	...
	websiteStartCmd := &cobra.Command{
		...
		Args:  cobra.ExactArgs(2),
		Long:  help.FormatLongHelp("Start a website with the specified name and listener ID"),
		Run: func(cmd *cobra.Command, args []string) {
...
website start web_test listener
	...
	websiteStopCmd := &cobra.Command{
		...
		Args:  cobra.ExactArgs(2),
		Long:  help.FormatLongHelp("Stop a website with the specified name and listener ID"),
		Run: func(cmd *cobra.Command, args []string) {
