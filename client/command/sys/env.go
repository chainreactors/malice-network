...
func Env(rpc clientrpc.MaliceRPCClient, session *session.Session) (*clientpb.Task, error) {
...
func SetEnv(rpc clientrpc.MaliceRPCClient, session *session.Session, envName, value string) (*clientpb.Task, error) {
...
func UnSetEnv(rpc clientrpc.MaliceRPCClient, session *session.Session, envName string) (*clientpb.Task, error) {
...
func RegisterEnvFunc(con *repl.Console) {
	...
	con.RegisterImplantFunc(
		...
		SetEnv,
		"bsetenv",
		func(rpc clientrpc.MaliceRPCClient, sess *session.Session, envName, value string) (*clientpb.Task, error) {
	...
	con.RegisterImplantFunc(
		...
		UnSetEnv,
		"bunsetenv",
		func(rpc clientrpc.MaliceRPCClient, sess *session.Session, envName string) (*clientpb.Task, error) {
