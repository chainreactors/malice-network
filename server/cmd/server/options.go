...
func (opt *Options) InitListener() error {
	...
	// The built-in listener connects locally. Remote listener auth is generated by `listener add`.
	listenerConf, fingerprint, err := certutils.GenerateListenerCert("127.0.0.1", name, int(cfg.GRPCPort))
	if err != nil {
